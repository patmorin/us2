...
\end{align*}
\todo{Continue reading here... (Aug 3)}Recall that we have already chosen $k:=\sqrt{d\Delta}\log^{1/4}\Delta$ and $M:=4\sqrt{d\Delta}/\log^{1/4}\Delta$.  Therefore $k/M=\tfrac{1}{4}\log^{1/2}\Delta$ and $k^2=d\Delta\log^{1/2}\Delta$, so
\begin{align*}
  (\E(X_i))^2

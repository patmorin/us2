...
\begin{align*}
  ...
  & = O\left(x_i\log^{2-2?} \Delta\right)
      + \frac{1}{k}\cdot\sum_{j=x_i/k+1}^k \left(\frac{x_i}{j}-\E(X_i)\right)^2
      & \text{(since $x_i\le kM$)} \\
  % & = x_i\log^{2-2?}\Delta + O\left(\frac{x_i^2\log^2 k}{k^2}\right)
  %     + \frac{1}{k}\cdot\sum_{j=x_i/k+1}^k \left(\frac{x_i}{j}-\E(X_i)\right)^2
  ...
  %     \\
  % & = O(x_i\log^{2-2?}\Delta) + \frac{1}{k}\cdot\sum_{j=x_i/k+1}^k \left(\frac{x_i}{j}-\E(X_i)\right)^2 \\
 ...
 & \le O(x_i\log^{2-2?}\Delta) + \frac{\pi^2 Mx_i}{6k} \\
  % & \le O(x_i\log^{3/2}\Delta) + \frac{\pi^2 x_i}{6}  \\
  & = O(x_i\log^{2-2?}\Delta)
\end{align*}
...
% To apply this in our setting, let $k:=\sqrt{d\Delta\log\Delta}$,
